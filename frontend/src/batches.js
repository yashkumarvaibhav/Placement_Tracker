...
export const METRIC_DEFINITIONS = {
  ...
  highest_ctc: 'Highest CTC in this cohort. If an offer-specific CTC is missing, the site falls back to the linked company CTC.',
  average_ctc: 'Average CTC counting each student once, at their highest recorded package. A student with several offers does not pull the average down with the lower ones. Offer CTC is used first, company CTC as fallback.',
  median_ctc: 'Median CTC counting each student once, at their highest recorded package. A student with several offers contributes a single value. Offer CTC is used first, company CTC as fallback.',
  highest_stipend: 'Highest stipend in this cohort. If an offer-specific stipend is missing, the site falls back to the linked company stipend.',
  average_stipend: 'Average stipend counting each student once, at their highest recorded stipend. Offer stipend is used first, company stipend as fallback.',
  median_stipend: 'Median stipend counting each student once, at their highest recorded stipend. Offer stipend is used first, company stipend as fallback.',
